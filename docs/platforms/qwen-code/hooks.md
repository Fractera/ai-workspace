...
- **Hook Registry**: Stores and manages all configured hooks
- **Hook Planner**: Determines which hooks should run for each event
- **Hook Runner**: Executes individual hooks with proper context
- **Hook Aggregator**: Combines results from multiple hooks
- **Hook Event Handler**: Coordinates the firing of hooks for events
