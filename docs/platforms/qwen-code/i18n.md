...
> **Note:** After changing the output language, restart Qwen Code for the change to take effect.
...
> **Tip:** Contributions are welcome! If you'd like to improve built-in translations or add new languages.
