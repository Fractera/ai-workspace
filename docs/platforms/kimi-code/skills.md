...
Agent Skills is an open format for adding specialized knowledge and workflows to AI agents. Kimi Code CLI supports loading Agent Skills to extend AI capabilities.
...
- **Mermaid:** Use ` ```mermaid ` code block, Mermaid Playground can be used for editing and preview
- **D2:** Use ` ```d2 ` code block, D2 Playground can be used for editing and preview
