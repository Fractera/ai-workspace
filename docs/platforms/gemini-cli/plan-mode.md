...
Plan Mode typically follows a linear path: research, propose, and draft. Adding
model steering lets you:
...
- Explore Agent Skills to add specialized expertise to your planning turns.
