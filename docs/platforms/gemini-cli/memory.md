...
- Learn about session management to see how short-term history works.
- Explore the command reference for more `/memory` options.
- Read the technical spec for project context (GEMINI.md).
- Try the experimental Auto Memory feature to extract reusable skills from your past sessions automatically.
