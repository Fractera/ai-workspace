...
> **NOTE:** The `command` is `docker`, and the rest are arguments passed to it. We
...
- Explore the MCP servers reference to learn about SSE and HTTP transports for remote servers.
