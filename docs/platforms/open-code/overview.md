...
- `$XDG_CONFIG_HOME/opencode/commands/` (typically `~/.config/opencode/commands/` on Linux/macOS)
...
If using one of the above plugins or cli tools, make sure you authenticate the tool with your github account. This should create a github token at one of the following locations:
