...
And to use it you can add the `mcp_everything` tool to your prompts:
...
Below are examples of some common MCP servers.
...
Add `use context7` to your prompts to use the Context7 MCP server:
